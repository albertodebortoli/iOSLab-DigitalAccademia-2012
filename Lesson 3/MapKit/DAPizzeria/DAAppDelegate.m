...
#define kStartingURL @"http://www.digitalaccademia.com"
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    tabbar.viewControllers = [NSArray arrayWithObjects:mapViewController, menuViewController, fridgeNavController, counterViewController, browserNavController, nil];
