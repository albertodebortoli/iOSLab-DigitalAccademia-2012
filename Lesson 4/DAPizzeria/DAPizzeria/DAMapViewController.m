...
- (void)manageAnnotationsJSON:(id)JSON
{
    ...
    for (NSDictionary *annotationDictionary in annotationsArray) {
        CGFloat latitude = [((NSString*)annotationDictionary[@"latitude"]) floatValue];
        CGFloat longitude = [((NSString*)annotationDictionary[@"longitude"]) floatValue];
        NSString *title = annotationDictionary[@"title"];
        NSString *subtitle = annotationDictionary[@"subtitle"];
        NSString *longDescription = annotationDictionary[@"longDescription"];
